...
class CallSession(models.Model):
    ...
    #replay_action_create = models.ManyToManyField(Advertisement, related_name='replay_action_create')
    #replay_action_update = models.ManyToManyField(Advertisement, related_name='replay_action_update')
    #replay_action_remove = models.ManyToManyField(Advertisement, related_name='replay_action_remove')
